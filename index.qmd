...
The EarthCODE Hackathon will bring together Ocean, Carbon, and Polar scientists,
experts in FAIR data and workflow engineering and open source developers to
focus on the creation and enhancement of thematic, analysis ready data
collections, built from scientific project outputs. These collections will
...
The main objective is to build open, analysis-ready *"data collections"* for
...
demonstrating their value in addressing emerging scientific questions.
